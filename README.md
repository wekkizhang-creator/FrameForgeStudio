# 光影造物 · FrameForge Studio

面向内容创作者的 AI 视频创作工作台。支持**账号登录/注册**与**项目 → 多条生成记录**管理，从脚本、分镜、本地合成到导出的一站式流程，UI 采用深色影像创作风格。
...
```text
邮箱：demo@guangying.ai
密码：123456
```

也可以在登录页切换到「注册」创建本地账号。
